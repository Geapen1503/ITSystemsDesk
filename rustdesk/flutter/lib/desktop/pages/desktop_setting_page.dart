...
class _SafetyState extends State<_Safety> with AutomaticKeepAliveClientMixin {
  ...
  Widget more(BuildContext context) {
    bool enabled = !locked;
    final PeerTabModel peerTabModel = Provider.of<PeerTabModel>(context, listen: false);

    peerTabModel.isDenyLanDiscovery = enabled;
    print('isDenyLanDiscovery: ${peerTabModel.isDenyLanDiscovery}');
