...
class PeerTabModel with ChangeNotifier {
  ...
  bool _isDenyLanDiscovery = false;

  bool get isDenyLanDiscovery => _isDenyLanDiscovery;

  set isDenyLanDiscovery(bool value) {
    if (_isDenyLanDiscovery != value) {
      _isDenyLanDiscovery = value;
      notifyListeners();
    }
  }
  ...
  /*static void updateIsEnabled(bool value) {
    isEnabled[2] = value;
  }*/
